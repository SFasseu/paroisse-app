...
<head>
    ...
    <link href="{{ asset('charitize/css/main.css') }}" rel="stylesheet">
</head>
        ...
        <div class="row align-items-center h-100">
            <div class="col-lg-4 text-center text-lg-start">
                <a href="index.html" class="logo-block">
                    <img src="{{ asset('charitize/img/logo.png') }}" alt="Logo Saint-Esprit Bepanda" width="15%">
                    <h1 class="display-5 text-primary m-0 logo-text">Holy Spirit Bepanda</h1>
                </a>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="ms-2">
                                ...
                                <span class="text-white">+237 699 999 999</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
